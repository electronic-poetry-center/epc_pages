...
Delicious.Mp3 = {
	...
	go: function() {
		...
		for (var i = 0, o; o = all[i]; i++) {
			if(o.href.match(/\.mp3$/i)) {
				...
				img.src = 'http://writing.upenn.edu/images/play.gif'; img.title = 'listen'
	...
	toggle: function(img, url) {
		if (Delicious.Mp3.playimg == img) Delicious.Mp3.destroy()
			...
			img.src = 'http://writing.upenn.edu/images/stop.gif'; Delicious.Mp3.playimg = img;
			...
			'<param name="movie" value="http://writing.upenn.edu/swf/playtagger.swf" /><param name="quality" value="high" />' +
			'<embed style="vertical-align:bottom;margin-right:0.2em" src="http://writing.upenn.edu/swf/playtagger.swf" flashVars="theLink='+url+'&amp;fontColor='+c+'"'+
	...
	destroy: function() {
		Delicious.Mp3.playimg.src = 'http://writing.upenn.edu/images/play.gif'; Delicious.Mp3.playimg = null
